...
Version: 3.1.0
Release: 1
Source: https://www.chocolate-doom.org/downloads/3.1.0/chocolate-doom-3.1.0.tar.gz
URL: https://www.chocolate-doom.org/
Group: Amusements/Games
BuildRoot: /var/tmp/chocolate-doom-buildroot
License: GNU General Public License, version 2
Packager: Simon Howard <https://github.com/chocolate-doom/chocolate-doom/issues>
Prefix: %{_prefix}
Autoreq: 0
